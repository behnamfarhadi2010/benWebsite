...
def main():
    ...
    project_json = parser.create_project_json(
        owner='behnamfarhadi2010', #dont forget to change this to your github username
        ...
        repo_url='https://github.com/behnamfarhadi2010/benWebsite', #dont forget to change this to your github repo url
        live_url='https://myweb-plum-eight.vercel.app', #dont forget to change this to your live website url or leave it blank if you dont have one
